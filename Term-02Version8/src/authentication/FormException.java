...
public class FormException {
	...
	public boolean IDFormCheck(String id) throws MyException {//¾ÆÀÌµð´Â ¿À·ÎÁö ¿µ¾î¿Í ¼ýÀÚ·Î¸¸
	...
	public boolean passwordFormCheck(String id) throws MyException{//ºñ¹Ð¹øÈ£´Â ¿µ¾î, ¼ýÀÚ ,(!@#$%^&*())ÀÇ Æ¯¼ö¹®ÀÚ°¡ Çã¿ë.
		if(Pattern.matches("^[a-zA-Z0-9!@#$%^&*()]*$", id)&&id.length()!=0)
			return true;
	...
	public boolean NameFormCheck(String id) throws MyException{//ÀÌ¸§Àº ÇÑ±Û°ú ¿µ¾î¸¸ °¡´É.
	...
	public boolean phoneFormCheck(String id) throws MyException {//ÇÚµåÆù¹øÈ£ Çü½ÄÀº 000-000(0)-0000
